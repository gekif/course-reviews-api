...
import com.gekif.course.CourseRepository;
import com.gekif.review.Review;
import com.gekif.user.User;
import com.gekif.user.UserRepository;
...
public class DatabaseLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        users.save(students);
        users.save(new User("gekif", "Dzulfikar", "Maulana", "12345", new String[] {"ROLE_USER", "ROLE_ADMIN"}));
